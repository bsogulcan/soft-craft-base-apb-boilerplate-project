...
{
    public abstract class BaseAbpBoilerplateProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BaseAbpBoilerplateProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BaseAbpBoilerplateProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BaseAbpBoilerplateProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BaseAbpBoilerplateProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BaseAbpBoilerplateProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BaseAbpBoilerplateProjectDbContext, Task<T>> func)
        {
            T result;
